...
function InventoryStatisticsCard({ color, title, icon, percentage }: Props): JSX.Element {
      ...
      <MDBox display="flex" justifyContent="space-between" pt={1} px={2}>
        ...
        <MDBox textAlign="right" lineHeight={1.25}>
          ...
          <ExecuteQuery
            ...
            dimensions={[]}
            measures={[measures.count(DM.Treatment.Name, "Total")]}
            filters={[]}
          >
            {(data: Data) => {
...
InventoryStatisticsCard.defaultProps = {
  color: "info",
  percentage: {
    color: "warning",
