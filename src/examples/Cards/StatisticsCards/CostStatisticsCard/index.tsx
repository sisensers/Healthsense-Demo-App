...
function CostStatisticsCard({ color, title, icon, percentage, filters }: Props): JSX.Element {
      ...
      <MDBox display="flex" justifyContent="space-between" pt={1} px={2}>
        ...
        <MDBox textAlign="right" lineHeight={1.25}>
          ...
          <ExecuteQuery
            ...
            dimensions={[]}
            measures={[measures.sum(DM.Healthsense.InsuranceClaimAmount, "Total")]}
            filters={[filters]}
          >
            {(data: Data) => {
...
CostStatisticsCard.defaultProps = {
  color: "info",
  percentage: {
    color: "warning",
    label: "Increased Cost 7%",
  },
};

export default CostStatisticsCard;
